...
/**
 * Criteria class for the {@link sn.dove.backend.domain.Reaction} entity. This class is used
 * in {@link sn.dove.backend.web.rest.ReactionResource} to receive all the possible filtering options from
...
public class ReactionCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, type, utilisateurId, messageId, distinct);
    }
