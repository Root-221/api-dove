...
import sn.dove.backend.service.ApplicationQueryService;
import sn.dove.backend.service.ApplicationService;
...
/**
 * REST controller for managing {@link sn.dove.backend.domain.Application}.
 */
@RestController
...
public class ApplicationResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ApplicationDTO>> getAllApplications(ApplicationCriteria criteria) {
        LOG.debug("REST request to get Applications by criteria: {}", criteria);

        List<ApplicationDTO> entityList = applicationQueryService.findByCriteria(criteria);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ApplicationDTO> getApplication(@PathVariable("id") UUID id) {
