...
import com.sonatel.api.dove.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.sonatel.api.dove.domain.Authority}.
 */
@RestController
...
public class AuthorityResource {
    ...
    @Value("${jhipster.clientApp.name:apidove}")
