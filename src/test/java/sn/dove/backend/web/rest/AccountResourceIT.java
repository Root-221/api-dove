...
import static sn.dove.backend.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static sn.dove.backend.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static sn.dove.backend.test.util.OAuth2TestUtil.testAuthenticationToken;
...
import sn.dove.backend.repository.UserRepository;
import sn.dove.backend.security.AuthoritiesConstants;
